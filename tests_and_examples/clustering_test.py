...
def clustering():
    ...
    cutoffs = [1.0e-6, 1.0e-5, 1.0e-4, 1.0e-3, 1.0e-2, 1.0e-1] 
    epsilons = [1.0e-6, 1.0e-5, 1.0e-4, 1.0e-3, 1.0e-2, 1.0e-1]
    reassignments = ['noise', 'whole', 'single']
    metrics = ['cosine', 'euclidean']
    dom_search = [True, False]
    best = c*n
    best_config = None
